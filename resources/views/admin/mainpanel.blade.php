 <div class="content-wrapper">
     ...
     <div class="modal fade" id="userDetailModal" tabindex="-1" aria-labelledby="userDetailModalLabel"
         aria-hidden="true">
         <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 600px; margin: auto;">
             <div class="modal-content bg-gray-dark text-white">
                         ...
                         <table class="table">
                             <thead>
                                 <tr>
                                     ...
                                     <th>Chart Photo</th> <!-- Changed from "Register Person Name" to reflect data -->
                                     <th>Register Person Name</th>
                                     <th>Register Person Phone Number</th>
                                     <th>Expectation</th>
                                     <th>Country of Residence</th>
                                     <th>Status</th> <!-- For the Approved badge -->
                                 </tr>
                             </thead>
                             <tbody>
                                 @foreach ($users as $user)
                                     <tr>
                                         ...
                                         <td>
                                             <img src="{{ asset('storage/' . $user->photo) }}" alt="image"
                                         ...
                                         <td>{{ $user->height }}</td> <!-- Added -->
                                         <td>{{ $user->weight }}</td> <!-- Added -->
                                         ...
                                         <td>
                                             @if ($user->chartphoto)
                                                 <img src="{{ asset('storage/' . $user->chartphoto) }}"
                                                     alt="chart photo"
                                         ...
                                         <td>{{ $user->register_person_name }}</td>
                                         <td>{{ $user->phone_number }}</td>
                                         <td>
                                             @php
                                                 $expectations = json_decode($user->expectation, true);
                                             @endphp
                                             {{ is_array($expectations) ? implode(', ', $expectations) : $user->expectation }}
                                         </td>
 ...
 <script>
     document.addEventListener('DOMContentLoaded', function() {
         const buttons = document.querySelectorAll('.view-user-btn');
